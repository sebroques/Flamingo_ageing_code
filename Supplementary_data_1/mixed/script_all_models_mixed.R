dir <- "D:/Senescence_analysis/Bird_data/Flamingo/Analyses_per_migration_strategy/mixed"
setwd(dir)
...
Flamingo_adult<-read.csv2("Flamingo_adult_mixed_1981.csv", dec=",", h=T)
head(Flamingo_adult)
...
# Export outputs
write.csv2(Gompertz_simple$params, "00_Gompertz_simple_mixed.csv")
write.csv2(Gompertz_simple$coefficients, "01_Gompertz_simple_mixed.csv")
write.csv2(Gompertz_simple$mortQuant, "02_Gompertz_simple_mixed.csv")
...
# Export outputs
write.csv2(Gompertz_bathtub$params, "00_Gompertz_bathtub_mixed.csv")
write.csv2(Gompertz_bathtub$coefficients, "01_Gompertz_bathtub_mixed.csv")
write.csv2(Gompertz_simple$mortQuant, "02_Gompertz_bathtub_mixed.csv")
...
# Export outputs
write.csv2(Gompertz_Makeham$params, "00_Gompertz_Makeham_mixed.csv")
write.csv2(Gompertz_Makeham$coefficients, "01_Gompertz_Makeham_mixed.csv")
write.csv2(Gompertz_Makeham$mortQuant, "02_Gompertz_Makeham_mixed.csv")
...
# Export outputs
write.csv2(Logistic_simple$params, "00_Logistic_simple_mixed.csv")
write.csv2(Logistic_simple$coefficients, "01_Logistic_simple_mixed.csv")
write.csv2(Logistic_simple$mortQuant, "02_Logistic_simple_mixed.csv")
...
# Export outputs
write.csv2(Logistic_bathtub$params, "00_Logistic_bathtub_mixed.csv")
write.csv2(Logistic_bathtub$coefficients, "01_Logistic_bathtub_mixed.csv")
write.csv2(Logistic_bathtub$mortQuant, "02_Logistic_bathtub_mixed.csv")
...
# Export outputs
write.csv2(Logistic_Makeham$params, "00_Logistic_Makeham_mixed.csv")
write.csv2(Logistic_Makeham$coefficients, "01_Logistic_Makeham_mixed.csv")
write.csv2(Logistic_Makeham$mortQuant, "02_Logistic_Makeham_mixed.csv")
...
# Export outputs
write.csv2(Weibull_simple$params, "00_Weibull_simple_mixed.csv")
write.csv2(Weibull_simple$coefficients, "01_Weibull_simple_mixed.csv")
write.csv2(Weibull_simple$mortQuant, "02_Weibull_simple_mixed.csv")
...
# Export outputs
write.csv2(Weibull_bathtub$params, "00_Weibull_bathtub_mixed.csv")
write.csv2(Weibull_bathtub$coefficients, "01_Weibull_bathtub_mixed.csv")
write.csv2(Weibull_bathtub$mortQuant, "02_Weibull_bathtub_mixed.csv")
...
# Export outputs
write.csv2(Weibull_Makeham$params, "00_Weibull_Makeham_mixed.csv")
write.csv2(Weibull_Makeham$coefficients, "01_Weibull_Makeham_mixed.csv")
write.csv2(Weibull_Makeham$mortQuant, "02_Weibull_Makeham_mixed.csv")
...
# Export outputs
write.csv2(Exponential$params, "00_Exponential_mixed.csv")
write.csv2(Exponential$coefficients, "01_Exponential_mixed.csv")
write.csv2(Exponential$mortQuant, "02_Exponential_mixed.csv")
